"""
Backward-compatible entry point for the pose-to-text setup path.

Delegates entirely to general_training_setup.main with
default_dataset_type="pose2text" so that configs that predate the
data.dataset_type field continue to work when --modality pose2text is given.
