#!/bin/bash
#SBATCH --job-name=signclip-pretrain-youtube-asl-10ep
...
CONFIG_PATH="${CONFIG_PATH:-/home/faxu/multimodalhugs/configs/signclip_pretrain_youtube_asl_10ep.server.yaml}"
