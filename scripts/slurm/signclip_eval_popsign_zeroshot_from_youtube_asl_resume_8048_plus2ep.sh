#!/bin/bash
#SBATCH --job-name=signclip-eval-popsign-zs-ytasl-r8048-p2
...
CONFIG_PATH="${CONFIG_PATH:-/home/faxu/multimodalhugs/configs/signclip_eval_popsign_zeroshot_from_youtube_asl_resume_8048_plus2ep.server.yaml}"
